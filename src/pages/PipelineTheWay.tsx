...
import { getApplications, updateApplicationStatus, type DBApplication } from "@/services/wayService";
    ...
    <div className="rounded-lg border border-border bg-card p-3 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
      <div className="flex items-start justify-between gap-2">
        ...
        <span className="text-[10px] text-muted whitespace-nowrap">
          {new Date(aplicacao.data_aplicacao).toLocaleDateString("pt-BR", { day: "2-digit", month: "short" })}
        </span>
      </div>
